...
def start_file_logger(filename: str, name: str = 'monitoring', level: int = logging.DEBUG,
...
class MonitoringHub(RepresentationMixin):
    def __init__(self,
                 ...
                 feedback_address: Optional[str] = None,
    ...
    def start(self, run_id: str, run_dir: str) -> int:
        ...
        self.router_proc = ForkProcess(target=router_starter,
                                       args=(
                                       comm_q, self.exception_q, self.priority_msgs, self.node_msgs, self.block_msgs,
                                       self.resource_msgs),
                                       kwargs={"hub_address": self.hub_address,
                                               "hub_port": self.hub_port,
                                               "hub_port_range": self.hub_port_range,
                                               "feedback_address": self.feedback_address,
                                               "logdir": self.logdir,
        ...
        self.dbm_proc = ForkProcess(target=dbm_starter,
                                    args=(self.exception_q, self.priority_msgs, self.node_msgs, self.block_msgs,
                                          self.resource_msgs,),
        ...
        self.dbm_proc.start()
        self.logger.info(
            "Started the router process {} and DBM process {}".format(self.router_proc.pid, self.dbm_proc.pid))
    ...
    def close(self) -> None:
        ...
        while True:
            try:
                ...
                self.logger.error(
                    "There was a queued exception (Either router or DBM process got exception much earlier?)")
            except queue.Empty:
                break
            ...
            while router_keep_going:
                ...
                try:
                    ...
                    while time.time() - dfk_loop_start < 1.0:  # TODO make configurable
                        ...
                        assert len(msg) == 2, "IC Channel expects message tuples of exactly length 2, got {}".format(
                            msg)
